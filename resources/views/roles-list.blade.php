                                ...
                                <tr>
                                    ...
                                    <ul class="list-unstyled hstack gap-1 mb-0">
                                        ...
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Permissions">
                                           ...
                                           <a href="{{ route('role.permissions',encrypt($role->id)) }}" class="btn btn-sm btn-soft-info">Permission</a>

                                        </li>

                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">

                                            <a href="{{ route('role.roleedit',encrypt($role->id)) }}" class="btn btn-sm btn-soft-info"><i class="mdi mdi-pencil-outline"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 py-5 text-center">
                    ...
                    <div class="hstack gap-2 justify-content-center mb-0">
                        ...
                        <a href="{{ route('role.roledelete', encrypt($role->id)) }}"><button type="button" class="btn btn-danger" id="remove-item">Remove Now</button></a>
