                                                                    ...
                                                                    <a href="#" style="background-color:#e3edfe;border-bottom:0px solid transparent;border-left:0px solid transparent;border-radius:14px;border-right:0px solid transparent;border-top:0px solid transparent;color:#052d3d;display:inline-block;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:14px;font-weight:undefined;mso-border-alt:none;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:auto;word-break:keep-all;" target="_blank">
                                                                        <span style="word-break: break-word; padding-left: 20px; padding-right: 20px; font-size: 14px; display: inline-block; letter-spacing: normal;">
                                                                            <span style="word-break: break-word;">
                                                                                <span data-mce-style="" style="word-break: break-word; line-height: 28px;">Pre-KYC Process - Addtional Informations Needed</span>
                                                                            </span>
                                                                        </span>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:18px;line-height:120%;text-align:center;mso-line-height-alt:21.599999999999998px;">
                                                                    <p style="margin: 0; margin-bottom:2% !important; word-break: break-word;"><span style="font-size:15px !important; word-break: break-word; color: rgb(0,0,0);">Greetings. We started processing your application and in need of some clarifications before start our KYC Process.</span></p>

                                                                    <p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: rgb(0,0,0);">Please click link below to address the Pre-KYC Process Queries. </span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                    ...
                                                                    <a href="{{$replyLink}}"
                                                                        ...
                                                                        <span style="word-break: break-word; padding-left: 40px; padding-right: 40px; font-size: 16px; display: inline-block; letter-spacing: normal;">
                                                                            <span style="word-break: break-word; line-height: 32px;">
                                                                                <strong>Queries on Pre-KYC Process</strong>
                                                                            </span>
                                                                        </span>
                                                                    </a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
