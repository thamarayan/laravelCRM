														...
														<tr>
															<td class="pad">
																<div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:18px;line-height:120%;text-align:center;mso-line-height-alt:21.599999999999998px;">
																	<p style="margin: 0; margin-bottom:2% !important; word-break: break-word;"><span style="font-size:15px !important; word-break: break-word; color: rgb(0,0,0);">As part of our Onboarding Process, We would like you to complete the KYC process using the link mentioned below. Thank you.</span></p>

																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: rgb(0,0,0);">Please click link below to initiate the KYC Process. </span></p>
																</div>
															</td>
														</tr>
													</table>
																	...
																	<a href="{{$uploadLink}}"
																		...
																		<span style="word-break: break-word; padding-left: 40px; padding-right: 40px; font-size: 16px; display: inline-block; letter-spacing: normal;">
																			<span style="word-break: break-word; line-height: 32px;">
																				<strong>Initiate KYC Process</strong>
																			</span>
																		</span>
																	</a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
																</div>
