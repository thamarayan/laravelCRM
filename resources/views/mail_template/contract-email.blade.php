														...
														<tr>
															<td class="pad" style="padding-left:15px;padding-right:10px;">
																<div style="color:#052d3d;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:34px;line-height:150%;text-align:center;mso-line-height-alt:51px;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;"><strong><span style="word-break: break-word;"><span style="word-break: break-word; color: rgb(33,144,227);">{{$company_name}}</span></span></strong></span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:18px;line-height:120%;text-align:center;mso-line-height-alt:21.599999999999998px;">
																	<p style="margin: 0; margin-bottom:2% !important; word-break: break-word;"><span style="font-size:15px !important; word-break: break-word; color: rgb(0,0,0);">Please find the Contract Document attached with this Mail and go through the same.</span></p>

																	<p style="margin: 0; font-size:15px !important; word-break: break-word;"><span style="word-break: break-word; color: rgb(0,0,0);">Please click link below to submit the signed document or to send any comments on the same. </span></p>
																</div>
															</td>
														</tr>
													</table>
																	...
																	<a href="{{$uploadLink}}"
																		...
																		<span style="word-break: break-word; padding-left: 40px; padding-right: 40px; font-size: 16px; display: inline-block; letter-spacing: normal;">
																			<span style="word-break: break-word; line-height: 32px;">
																				<strong>UPLOAD SIGNED CONTRACT / ANY SUGGESTIONS</strong>
																			</span>
																		</span>
																	</a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
																</div>
