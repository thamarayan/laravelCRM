    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form id="myForm" action="{{url('leave_type/update', $leave->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body mt-3">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="leave_name" placeholder="Enter Leave Type" value="{{$leave->leave_name}}" class="form-control" required>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="no_of_days" value="{{$leave->no_of_days}}" placeholder="Enter Days" class="form-control" required>
