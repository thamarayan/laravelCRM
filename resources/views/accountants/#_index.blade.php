                            ...
                            <div class="text-sm-end">
                                ...
                                <a href="{{route('accounts.create')}}">
                                       ...
                                       <button type="button" class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i
                                        ...
                                        class="mdi mdi-plus me-1"></i> New Account</button>
                        ...
                        <table class="table align-middle table-nowrap table-hover dt-responsive nowrap w-100"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Equity (Initial balance): $0.00</br>
                                        Total in: $0.00</br>
                                        Total out: $0.00</br>
                                        <hr>
                                    Balance (in home currency) : $0.00</td>

                                     <td>

                                    <ul class="list-unstyled hstack gap-1 mb-0">

                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="initial balance add">

                                           <a href="{{ route('viewmore') }}" class="btn btn-sm btn-soft-info"><i

                                        class="mdi mdi-plus me-1"></i> Record initial balance</a>
                                        ...
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                           ...
                                           <a href="{{ route('accounts.edit') }}" class="btn btn-sm btn-soft-info"><i class="mdi mdi-pencil-outline"></i></a>
