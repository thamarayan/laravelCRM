                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="avatar-md profile-user-wid mb-2 d-flex">
                                    ...
                                    <img src="{{ isset($users->avatar) ? asset($users->avatar) : asset('build/images/users/profile.png') }}" alt="" class="img-thumbnail rounded-circle">

                                    <div class="ml-10">
                                        
                                       <h6 class="ml-10 mt-5">@if($totalcost->cost!=null) <span class="spancost">{{$totalcost->currency}}{{$totalcost->cost}}/hours</span>  @endif</h6>
                                ...
                                <p class="m-0"><strong class="m-0">Phone:&nbsp;&nbsp;</strong>{{ $users->phone }}</p>
                                <p class="m-0"><strong class="m-0">Email:&nbsp;&nbsp;</strong>{{ $users->email }}</p>
                               
                                <p class="m-0"><strong class="m-0">Status:&nbsp;&nbsp;</strong>{{ $users->status == 1 ? 'Active' : 'Inactive' }}</p> 
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted fw-medium"><a href="{{url('user/attendance', encrypt($users->id))}}" class="text-muted">Attendance</a></p>

                                        <h5 class="mb-0">{{$t_hours}}: {{$t_minutes}} </h5>
