        ...
        <form action="" method="Get">
            <div class="row">
                ...
                <div class="col-md-2 form-group">
                    ...
                    <input type="date" name="date_from" class="form-control" value="{{ $s_date }}" id="orderdatefrom">
                </div>

                <div class="col-md-2 form-group">
                    <label for="date_to">Date To</label>
                    <input type="date" class="form-control" name="date_to" value="{{ $e_date }}"  id="orderdateto">
                </div>
                ...
                <table class="table table-bordered" id="Leavetable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ date('j M Y h:i a', strtotime($post->orderDate)) }}</td>
                            <td>{{ $post->amount }}</td>
                            <td>{{ $post->currency }}</td>
                            <td>{{ round($post->amount*(6.30/100),2) }}</td>
                            <td>{{ round($post->amount*(0.50/100),2) }}</td>
                            <td>{{ round($post->amount-($post->amount*(6.30/100)),2) }}</td>
                            <td>{{ round($post->amount-($post->amount*(6.30/100))*5/100,2) }}</td>
                            <td>{{ round(($post->amount-($post->amount*(6.30/100)))-(($post->amount-($post->amount*(6.30/100)))*5/100),2) }}</td>
