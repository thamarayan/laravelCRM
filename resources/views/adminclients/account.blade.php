                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h5 class="mb-0"><a href="{{url('/admin/client/transaction/calculation', encrypt($users->id))}}">Click</a></h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h5 class="mb-0"><a href="{{url('/admin/client/refunded', encrypt($users->id))}}">Click</a></h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h5 class="mb-0"><a href="{{url('/admin/client/chargeback', encrypt($users->id))}}">Click</a></h5>
                ...
                <table class="table table-bordered" id="report">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Failed</td>
                            <td>Loren Robbins</td>
                            <td>lorenrobbins@hotmail.com </td>
                            <td>US</td>
                            <td>658465846</td>
                            <td>47369878462</td>
                            <td>100</td>
