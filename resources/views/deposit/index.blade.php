                        ...
                        <table class="table align-middle table-nowrap table-hover dt-responsive nowrap w-100"
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a href="{{ route('depositedit') }}">Invoice 3 Payment</a></td>
                                 ...
                                 <tr>
                                    ...
                                    <td><a href="{{ route('depositedit') }}">Web Development</a></td>
                                ...
                                <tr>
                                   ...
                                   <td><a href="{{ route('depositedit') }}">Sales</a></td>
                                ...
                                <tr>
                                   ...
                                   <td><a href="{{ route('depositedit') }}">Consultancy</a></td>
                               ...
                               <tr>
                                    ...
                                    <td><a href="{{ route('depositedit') }}">Record initial balance</a></td>
