<?php $__env->startSection('title'); ?>
    ...
    <?php echo app('translator')->get('Adminstats'); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <select class="form-control user_name" name="user_name">
                                    ...
                                    <?php $__currentLoopData = $merchent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mer->name); ?>" <?php echo e($request->user_name==$mer->name?'selected':''); ?>><?php echo e($mer->name); ?></option>
                    ...
                    <form action="<?php echo e(route('export.client.transaction')); ?>" method="Get">
                        ...
                        <input type="hidden" name="merchent" value="<?php echo e($request->user_name); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/payit123crm/public_html/CRM/resources/views/reporting/admin_client_tran.blade.php ENDPATH**/ ?>