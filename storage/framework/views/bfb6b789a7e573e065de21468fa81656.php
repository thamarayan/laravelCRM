    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchClients(search = "") {
                $.ajax({
                    url: "<?php echo e(route('merchantsConfig')); ?>",
                    type: "GET",
                    data: {
                        search: search
                    },
            ...
            $(document).on("click", ".save-config", function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('addMerchantConfig')); ?>", // Update this with your actual update route
                    type: "POST",
                    data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelCRM\resources\views/routings/merchants.blade.php ENDPATH**/ ?>