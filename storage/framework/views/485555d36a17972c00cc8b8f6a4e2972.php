...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center fail-container">
        <div class="card text-center">
            ...
            <!-- Optional button -->
            <a href="<?php echo e(route('payment.page')); ?>" class="btn btn-outline-danger mt-4">Return to payment page?</a>
        </div>
    </div>
...
<?php /**PATH D:\laravelCRM\resources\views/paymentProcess/fail.blade.php ENDPATH**/ ?>