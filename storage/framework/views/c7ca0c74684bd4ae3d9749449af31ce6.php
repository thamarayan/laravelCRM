        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('payment.request')): ?>
                            <li><a href="<?php echo e(route('merchantsConfig')); ?>" key="">Merchants</a></li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('payment.requested')): ?>
                            <li><a href="<?php echo e(route('pspsConfig')); ?>" key="">PSP</a></li>
                        <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['accounting.accounts', 'accounting.account_create', 'accounting.deposit', 'accounting.expense',
                ...
                <li>
                    <a href="<?php echo e(url('/transactions')); ?>" class="waves-effect">
                        <i class="bx bx-chat"></i>
                        <span>Transactions</span>
                    </a>
                </li>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('WeeklyReports.manage')): ?>
                    <li>
...
<!-- Left Sidebar End -->
<?php /**PATH D:\laravelCRM\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>