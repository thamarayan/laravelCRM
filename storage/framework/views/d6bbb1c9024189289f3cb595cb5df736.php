...
<!-- Bootstrap Css -->
<link href="<?php echo e(url('build/css/bootstrap.min.css')); ?>" id="bootstrap-style" rel="stylesheet" type="text/css" />
<!-- Icons Css -->
<link href="<?php echo e(url('build/css/icons.min.css')); ?>" rel="stylesheet" type="text/css" />
<!-- App Css-->
<link href="<?php echo e(url('build/css/app.min.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
<!-- App js -->
<!--<script src="<?php echo e(url('build/js/plugin.js')); ?>"></script>-->
...
</style><?php /**PATH C:\Users\kumar\Downloads\CRM_21stMarch\CRM\resources\views/layouts/head-css.blade.php ENDPATH**/ ?>