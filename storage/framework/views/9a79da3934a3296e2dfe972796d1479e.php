        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="text-align: left;">
                <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('build/images/logo.svg')); ?>" alt="" height="40">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="#" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('build/images/logo-light.svg')); ?>" alt="" height="40">
                    </span>
                    <span class="logo-lg">
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('build/images/users/profile.png')); ?>"
                    alt="Header Avatar">
...
<?php /**PATH C:\Users\kumar\Downloads\CRM_21stMarch\CRM\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>