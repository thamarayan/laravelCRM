...
class AedTransactionsExport implements FromCollection, WithTitle, WithHeadings, ShouldAutoSize, WithEvents
{
    protected $data;
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $totalPspValue_AED = $sheet->getCell("Z{$lastRow}")->getCalculatedValue();
                Session::put('totalPspValue_AED', $totalPspValue_AED);
