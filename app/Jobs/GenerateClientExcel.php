            ...
            foreach ($merchants as $merchant) {
                ...
                if ($tableName !== 'pay_orders_xm_refund') {
                    ...
                    WeeklyReports::updateOrCreate(
                        ...
                        ['clientName' => $tableName, 'startDate' => $fromDate, 'endDate' => $toDateFull, 'user_ID' => $merchant->clientDetails->client_id, 'payoutAmt' => $amt_owe_to_client, 'status' => null, 'filePath' => $filePath]
                    );
