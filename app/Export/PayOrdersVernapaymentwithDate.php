...
use App\Models\PayOrdersVernapayment;
...
class PayOrdersVernapaymentwithDate implements FromCollection, WithHeadings,WithEvents
{
       ...
       {
        return PayOrdersVernapayment::whereDate('orderDate','>=',$this->s_date)->whereDate('orderDate','<=',$this->e_date)->get();
       }
