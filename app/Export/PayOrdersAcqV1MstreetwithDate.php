...
class PayOrdersAcqV1MstreetwithDate implements FromCollection, WithHeadings,WithEvents
{
       ...
       {
        return PayOrdersAcqV1::where('merchantName','Mstreet')->whereDate('orderDate','>=',$this->s_date)->whereDate('orderDate','<=',$this->e_date)->get();
       }
