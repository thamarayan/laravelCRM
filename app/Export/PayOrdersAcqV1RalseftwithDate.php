...
class PayOrdersAcqV1RalseftwithDate implements FromCollection, WithHeadings,WithEvents
{
       ...
       {
        return PayOrdersAcqV1::where('merchantName','Ralseft')->whereDate('orderDate','>=',$this->s_date)->whereDate('orderDate','<=',$this->e_date)->get();
       }
