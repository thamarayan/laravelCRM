...
use App\Models\PayOrdersVernapaymentv4;
...
class PayOrdersVernapaymentv4withDate implements FromCollection, WithHeadings,WithEvents
{
       ...
       {
        return PayOrdersVernapaymentv4::whereDate('orderDate','>=',$this->s_date)->whereDate('orderDate','<=',$this->e_date)->get();
       }
