...
use App\Models\PayOrdersVernapaymentv1;
...
class PayOrdersVernapaymentv1withDate implements FromCollection, WithHeadings,WithEvents
{
       ...
       {
        return PayOrdersVernapaymentv1::whereDate('orderDate','>=',$this->s_date)->whereDate('orderDate','<=',$this->e_date)->get();
       }
